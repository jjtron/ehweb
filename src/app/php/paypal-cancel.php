    ...
    <div class="text-center" style="padding: 20px; color: #fff;">
        ...
        <div class="row" style="padding: 20px; color: #fff;">
            <div class="col-md-6 offset-md-3" style="font-size: 18px;">
                <p align="justify">We are sorry you decided not to purchase your card reading service. The offer is still open, just click the link you have in your e-mail and the order will still be there for you to get.</p>
            </div>
        </div>
    </div>
</div>
